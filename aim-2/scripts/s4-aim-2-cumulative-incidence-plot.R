...
stcurve_v1 <- read_dta('V:/Health and Retirement Study/edie/projects/smoking-cessation/2022-03-13 data/stcurve.dta')
...
stcurve_overall <- read_dta('V:/Health and Retirement Study/edie/projects/smoking-cessation/2022-03-13 data/stcurve-overall.dta')
...
stcompet_curve <- readr::read_csv('V:/Health and Retirement Study/edie/projects/smoking-cessation/2022-03-13 data/cif-stcompet-data-3.csv')
...
stcompet_overall <- readr::read_csv('V:/Health and Retirement Study/edie/projects/smoking-cessation/2022-03-13 data/cif-stcompet-overall-3.csv')
