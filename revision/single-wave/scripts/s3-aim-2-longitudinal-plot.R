...
long_data_v0 <- read_csv('V:/Health and Retirement Study/edie/projects/smoking-cessation/rr-aim-2-long.csv')
...
write_csv(count_tab_1, '../tables/rr-cohort-longitudinal-v1-counts.csv')
...
ggsave(plot=last_plot(), filename='../plots/rr-cohort-longitudinal-v1.png', dpi=300, height=7, width=10)
...
write_csv(count_tab_2, '../tables/rr-cohort-longitudinal-v2-counts.csv')
...
ggsave(plot=last_plot(), filename='../plots/rr-cohort-longitudinal-v2.png', dpi=300, height=7, width=10)
...
write_dta(long_data_v5, 'V:/Health and Retirement Study/edie/projects/smoking-cessation/rr-aim-2-long-v2.dta')
