...
stcurve_v1 <- read_dta('V:/Health and Retirement Study/edie/projects/smoking-cessation/2022-10-06 data/rr-cif-stcurve.dta')
...
stcurve_overall <- read_dta('V:/Health and Retirement Study/edie/projects/smoking-cessation/2022-10-06 data/rr-stcurve-overall.dta')
...
ggsave(plot=last_plot(), filename='../plots/rr-cif-stcurve-overall.png', dpi=300, height=7, width=10)
...
stcompet_curve <- readr::read_csv('V:/Health and Retirement Study/edie/projects/smoking-cessation/2022-10-06 data/rr-cif-stcompet-data.csv')
...
ggsave(plot=last_plot(), filename='../plots/rr-cif-stcompet.png', dpi=300, height=7, width=10)



stcompet_overall <- readr::read_csv('V:/Health and Retirement Study/edie/projects/smoking-cessation/2022-10-06 data/rr-cif-stcompet-overall.csv')
...
ggsave(plot=last_plot(), filename='../plots/rr-cif-stcompet-overall.png', dpi=300, height=7, width=10)
