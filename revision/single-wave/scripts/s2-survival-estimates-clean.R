...
surv_est_b_v0 <- read_excel('../tables/rr-survival-estimates.xlsx', sheet='unadjusted')
...
# Saturated
surv_est_s_v0 <- read_excel('../tables/rr-survival-estimates.xlsx', sheet='saturated')
...
# MICE
surv_est_m_v0 <- read_excel('../tables/rr-survival-estimates.xlsx', sheet='mice')
...
write_csv(full_table, '../tables/rr-survival-estimates-combined.csv')
