...
gen FOLLOWUP_TIME=AGE_OUTCOME-AGE_1998
sum FOLLOWUP_TIME, detail
sum FOLLOWUP_TIME if OUTCOME==0, detail
sum FOLLOWUP_TIME if OUTCOME==1, detail
sum FOLLOWUP_TIME if OUTCOME==2, detail



*tab OUTCOME if SUBPOP_SA==1
*tab OUTCOME if SUBPOP==1
tabout OUTCOME if SUBPOP_SA==1 using "../tables/count-outcomes-2.txt", format(0) replace
tabout OUTCOME if SUBPOP==1 using "../tables/count-outcomes-1.txt", format(0) replace
...
collect export "../tables/smoking-cessation-table1.xlsx", sheet("table_1") replace
...
collect export "../tables/survival-estimates.xlsx", sheet(unadjusted) modify
...
collect export "../tables/survival-estimates.xlsx", sheet(saturated) modify
...
collect export "../tables/survival-estimates.xlsx", sheet(mice) modify
